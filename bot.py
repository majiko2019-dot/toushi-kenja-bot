...
AFFILIATE_LINKS = {
    ...
    "マネックス証券": "https://h.accesstrade.net/sp/cc?rk=0100q1bu00ot1y",
    "マネックス証券 FXPLUS（マネックスのFX口座）": "https://h.accesstrade.net/sp/cc?rk=0100pldr00ot1y",
    ...
    "ウェルスコーチ（不動産投資会社の一括比較）": "https://px.a8.net/svt/ejp?a8mat=4B3WJ8+BIZ7QI+1LP8+15OK2A",
...
KEYWORDS = [
    ...
    "投資 勉強 本 初心者 おすすめ",
    "auカブコム証券 評判 口コミ",
    # ═══ KW在庫投入（2026-07-17・出典: kw_inventory_20260623.md＝Ubersuggest解約前の最終実測値）═══
    "楽天証券 NISA 始め方 手順",            # Vol:1,000  SD:39  ★Transactional・開設導線
    "SBI証券 始め方 口座開設 手順",          # Vol:590    SD:28  開設導線
]
